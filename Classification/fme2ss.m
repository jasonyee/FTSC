%% fme2ss
%  converting a functional mixed effect model
%   to a multivariate state-space model.

function SSModel = fme2ss(fixedDesign, randomDesign, t, logpara, diffusePrior)
...
%       http://www.jstor.org/stable/3068297?seq=1#page_scan_tab_contents
    ...
    SSModel.TranMX = H0;
    SSModel.DistMean = zeros(d,m);
    SSModel.DistCov = sigma0;
    SSModel.MeasMX = F;
    SSModel.ObseCov = sigma_e;
    SSModel.StateMean0 = x00;
    SSModel.StateCov0 = P00;
