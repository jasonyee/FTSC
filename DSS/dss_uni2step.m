%% dss_uni2step
%  dss_uni2step is a faster version of dss_uni

function [KalmanFitCell, loglik, prior]= ...
    dss_uni2step(TranMX, DistMean, DistCov, MeasMX, ObseCov, data, StateMean0, StateCov0)
%Input: t=1:T
...
%       -OneSubStateCov0: initial state covariance matrix
    ...
    for i=1:2
        ...
        OneSubStateCov0 = OneSubStateCov0 + ...
            KalmanFit.Ctp1(:,:,1)*(KalmanFit.FilteredCov(:,:,1) ...
