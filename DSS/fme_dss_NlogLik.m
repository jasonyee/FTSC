%% fme_dss_NlogLik
%  fme_dss_NlogLik returns the negative log-likelihood value of
%  a functional mixed effect model using dyanmic Kalman smoothing.

function NlogLik = fme_dss_NlogLik(Y, fixedDesign, randomDesign, t, logpara, diffusePrior)
