%% SYMQ7 data, built-in, cubic spline(F), sin prior(R)
...
path_data = 'Y:\Users\Jialin Yi\data\SYMQ7\';
...
for nClusters = nCLower:nCUpper
    ...
    % load data
    load(strcat(path_data, 'SYMQ7_dif_',num2str(nClusters),'C.mat'));
    dataset = symq7_dif;
    ...
    % save result
    save(strcat(path_result, 'SYMQ7_dif_FC_',num2str(nClusters),'C.mat'));
