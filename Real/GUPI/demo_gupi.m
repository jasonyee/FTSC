%%  GUPI: Sensitivity analysis, switches plot and random subject fit plotting
...
load(strcat(path_result, 'GUPI_dif_FC_', num2str(NumC),'C.mat'));
...
for k=1:nClusters
    ...
    f = figure;
    p = uipanel('Parent',f,'BorderType','none'); 
    p.Title = strcat('GUPI: subjects in Cluster',num2str(k)); 
    p.TitlePosition = 'centertop'; 
    p.FontSize = 12;
    p.FontWeight = 'bold';
